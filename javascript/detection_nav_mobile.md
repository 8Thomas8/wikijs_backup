...
Cette fonction retourne false si le navigateur n'est pas un navigateur mobile, et true si le navigateur est un navigateur mobile.

Il est possible de forcer la valeur de retour à true, pour des tests sur desktop en passant en paramètre true, à la fonction.
...
La fonction utilise une regex imbuvable, mais permet de détecter les navigateurs mobiles.